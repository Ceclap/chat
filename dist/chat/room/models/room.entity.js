...
let RoomEntity = exports.RoomEntity = class RoomEntity {
};
__decorate([
...
__decorate([
    (0, typeorm_1.ManyToMany)(() => user_entity_1.UserEntity, (user) => user.rooms),
    (0, typeorm_1.JoinTable)(),
    __metadata("design:type", Array)
], RoomEntity.prototype, "users", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => joined_room_entity_1.JoinedRoomEntity, (joinedUsers) => joinedUsers.user),
    __metadata("design:type", Array)
], RoomEntity.prototype, "joinedUsers", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => message_entity_1.MessageEntity, (messages) => messages.room),
    __metadata("design:type", Array)
